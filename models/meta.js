...
class Meta {
    ...
    static metaDes(f, city) {
        ...
        if (f === 'very') {
            ...
            let metaR = `VIP ESCORT. Самые лучшие VIP эскортницы ${c} на сайте ZODIAK. Выбор для самых изибирательных мужчин,эскортниц и индивидуалок ${c}`
            return metaR
        } else if (f === `desc`) {
            let metaR = `Дешевые индивидуалки и проститутки ${c}. Прекрасный выбор проституткок ${c} на портале ZODIAK`
            return metaR
        }
    }
